    ...
    return (
        <div className="grid grid-cols-3 gap-3 text-center md:flex md:flex-1 md:justify-around md:gap-0">
            <div className="md:min-w-[80px] lg:min-w-[90px]">
                <span className="text-[14px] font-semibold text-[#dc2626] block">{serviceDetails.invoiceNo}</span>
            ...
            <div className="md:min-w-[80px] lg:min-w-[90px]">
                <span className="text-[14px] font-semibold text-[#dc2626] block">{serviceDetails.paid}</span>
                <div className="text-[12px] text-[#7D7C7C]">Paid (Cust)</div>
            </div>
            <div className="md:min-w-[80px] lg:min-w-[90px]">
                <span className="text-[14px] font-semibold text-[#dc2626] block">{serviceDetails.due}</span>
